        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <a
              ...
              className="hidden sm:inline-flex items-center gap-2 bg-[#DA291C] text-white px-5 py-2.5 rounded-full text-sm font-medium hover:bg-[#B41E13] transition-colors"
            >
